...
define(['angular/map/device'], function(device) {

  var Declutterer = (function() {
    // Creates a declutterer, i.e. an engine working in the background on avoiding that marker
    ...
    function Declutterer(map, projectionFactory, markers, currentPositionMarker, $interval) {
      ...
      // Called when the device is detected to be slow.
      ...
      function doTick() {
        ...
        var viewportBottomLeft = projection.fromLatLngToContainerPixel(
